...
function UserSignup() {
  ...
  return (
    <div className='p-7 flex flex-col justify-between h-screen'>
      ...
      <div>
        <Link to={"/captain-signup"} className='bg-[#10b461] flex items-center justify-center text-[#fff] font-semibold mb-5 rounded px-4  py-2 w-full text-lg placeholder:text-base'>Sugnup as Captain</Link>
      </div>
